...
Public Class frm_withdraw_ssspayment
    Dim postno As Integer = 0
    Dim runbal As Integer = 0

    Private Sub frm_withdraw_ssspayment_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
