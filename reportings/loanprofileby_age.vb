...
Public Class loanprofileby_age
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.loanprofileby_age.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedloanprofileby_age
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As loanprofileby_age = New loanprofileby_age()
        rpt.Site = Me.Site
        Return rpt
    End Function
