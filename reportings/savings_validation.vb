...
Public Class savings_validation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.savings_validation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsavings_validation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As savings_validation = New savings_validation()
        rpt.Site = Me.Site
        Return rpt
    End Function
