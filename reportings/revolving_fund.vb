...
Public Class revolving_fund
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.revolving_fund.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrevolving_fund
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As revolving_fund = New revolving_fund()
        rpt.Site = Me.Site
        Return rpt
    End Function
