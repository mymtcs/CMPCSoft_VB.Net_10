...
Public Class minidisclosureIL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.minidisclosureIL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedminidisclosureIL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As minidisclosureIL = New minidisclosureIL()
        rpt.Site = Me.Site
        Return rpt
    End Function
