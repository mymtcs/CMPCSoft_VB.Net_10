...
Public Class abstractsavings
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.abstractsavings.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedabstractsavings
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As abstractsavings = New abstractsavings()
        rpt.Site = Me.Site
        Return rpt
    End Function
