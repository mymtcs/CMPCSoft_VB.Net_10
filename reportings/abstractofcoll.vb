...
Public Class abstractofcoll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.abstractofcoll.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedabstractofcoll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As abstractofcoll = New abstractofcoll()
        rpt.Site = Me.Site
        Return rpt
    End Function
