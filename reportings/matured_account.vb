...
Public Class matured_account
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.matured_account.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmatured_account
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As matured_account = New matured_account()
        rpt.Site = Me.Site
        Return rpt
    End Function
