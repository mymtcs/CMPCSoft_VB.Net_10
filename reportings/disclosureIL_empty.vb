...
Public Class disclosureIL_empty
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.disclosureIL_empty.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddisclosureIL_empty
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As disclosureIL_empty = New disclosureIL_empty()
        rpt.Site = Me.Site
        Return rpt
    End Function
