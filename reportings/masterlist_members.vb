...
Public Class masterlist_members
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.masterlist_members.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmasterlist_members
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As masterlist_members = New masterlist_members()
        rpt.Site = Me.Site
        Return rpt
    End Function
