...
Public Class abstractofstocks_rel
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "abstractofstocks_rel.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.abstractofstocks_rel.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedabstractofstocks_rel
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As abstractofstocks_rel = New abstractofstocks_rel()
        rpt.Site = Me.Site
        Return rpt
    End Function
