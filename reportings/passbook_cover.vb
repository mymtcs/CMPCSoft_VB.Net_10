...
Public Class passbook_cover
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.passbook_cover.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpassbook_cover
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As passbook_cover = New passbook_cover()
        rpt.Site = Me.Site
        Return rpt
    End Function
