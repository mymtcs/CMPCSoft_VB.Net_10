...
Public Class masterlist_by_product
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "masterlist_by_product.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.masterlist_by_product.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedmasterlist_by_product
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As masterlist_by_product = New masterlist_by_product()
        rpt.Site = Me.Site
        Return rpt
    End Function
