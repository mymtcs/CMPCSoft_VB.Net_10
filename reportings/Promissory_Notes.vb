...
Public Class Promissory_Notes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.Promissory_Notes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPromissory_Notes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Promissory_Notes = New Promissory_Notes()
        rpt.Site = Me.Site
        Return rpt
    End Function
