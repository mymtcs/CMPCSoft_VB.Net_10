...
Public Class portfolio_at_risk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.portfolio_at_risk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedportfolio_at_risk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As portfolio_at_risk = New portfolio_at_risk()
        rpt.Site = Me.Site
        Return rpt
    End Function
