...
Public Class collectionsheet_IL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.collectionsheet-IL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcollectionsheet_IL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As collectionsheet_IL = New collectionsheet_IL()
        rpt.Site = Me.Site
        Return rpt
    End Function
