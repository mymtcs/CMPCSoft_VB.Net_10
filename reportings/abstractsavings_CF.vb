...
Public Class abstractsavings_CF
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.abstractsavings_CF.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedabstractsavings_CF
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As abstractsavings_CF = New abstractsavings_CF()
        rpt.Site = Me.Site
        Return rpt
    End Function
