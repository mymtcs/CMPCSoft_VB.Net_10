...
Public Class ctr_incentives
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.ctr_incentives.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedctr_incentives
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ctr_incentives = New ctr_incentives()
        rpt.Site = Me.Site
        Return rpt
    End Function
