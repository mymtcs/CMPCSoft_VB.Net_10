...
Public Class loanrel_consumables
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "loanrel_consumables.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.loanrel_consumables.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedloanrel_consumables
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As loanrel_consumables = New loanrel_consumables()
        rpt.Site = Me.Site
        Return rpt
    End Function
