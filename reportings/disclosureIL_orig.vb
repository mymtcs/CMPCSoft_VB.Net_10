...
Public Class disclosureIL_orig
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.disclosureIL_orig.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddisclosureIL_orig
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As disclosureIL_orig = New disclosureIL_orig()
        rpt.Site = Me.Site
        Return rpt
    End Function
