...
Public Class cashiersblotter
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.cashiersblotter.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcashiersblotter
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cashiersblotter = New cashiersblotter()
        rpt.Site = Me.Site
        Return rpt
    End Function
