...
Public Class DisclosureStatements_items
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DisclosureStatements_items.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.DisclosureStatements_items.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDisclosureStatements_items
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DisclosureStatements_items = New DisclosureStatements_items()
        rpt.Site = Me.Site
        Return rpt
    End Function
