...
Public Class rev_cashreceipts
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.rev_cashreceipts.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrev_cashreceipts
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rev_cashreceipts = New rev_cashreceipts()
        rpt.Site = Me.Site
        Return rpt
    End Function
