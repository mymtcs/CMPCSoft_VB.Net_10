...
Public Class collectionsheet_CL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.collectionsheet-CL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcollectionsheet_CL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As collectionsheet_CL = New collectionsheet_CL()
        rpt.Site = Me.Site
        Return rpt
    End Function
