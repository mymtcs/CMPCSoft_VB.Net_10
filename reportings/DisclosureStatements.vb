...
Public Class DisclosureStatements
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "DisclosureStatements.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.DisclosureStatements.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDisclosureStatements
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DisclosureStatements = New DisclosureStatements()
        rpt.Site = Me.Site
        Return rpt
    End Function
