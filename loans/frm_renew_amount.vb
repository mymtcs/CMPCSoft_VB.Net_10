...
Public Class frm_renew_amount
    ...
    Private Sub bttnok_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnok.Click
        If MessageBox.Show("Are you sure you want to renew this loan?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub bttncompute_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttncompute.Click, txtRenewAmt.Validated
        'Gross Proceeds
        'txtNetLoanAmt.Text = Double.Parse(txtRenewAmt.Text) - Double.Parse(txtprin.Text)

        'Total Loan Balance: formula Principal + Life & Health amount
        'txtTotalLoanBal.Text = Double.Parse(txtprin.Text) + Double.Parse(txtLHPayments.Text)

        'Gross Proceeds: formula RenewAmount - TotalLoanbalance 
        'txtNetLoanAmt.Text = Double.Parse(txtRenewAmt.Text) - Double.Parse(txtTotalLoanBal.Text)
        ...
        'cycle new
        'txtcycle.Text = Math.Round((Double.Parse(txtRenewAmt.Text)) / Double.Parse(txtpayment.Text))

        'txtpayment.Text = Math.Round((Double.Parse(txtRenewAmt.Text)) / Double.Parse(txtcycle.Text))

        txtpayment.Text = CDbl(txtRenewAmt.Text) / CDbl(txtcycle.Text)
        'MsgBox(txtpayment.Text)
    ...
    Private Sub txtLHPayments_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtLHPayments.KeyPress
        Try
            Dim dot As Integer, ch As String
            If Not Char.IsDigit(e.KeyChar) Then e.Handled = True
            If e.KeyChar = "." And txtLHPayments.Text.IndexOf(".") = -1 Then e.Handled = False 'allow single decimal point

            dot = txtLHPayments.Text.IndexOf(".")
            If dot > -1 Then            'allow only 2 decimal places
                ch = txtLHPayments.Text.Substring(dot + 1)
                If ch.Length > 1 Then e.Handled = True 'does not allow any other keypresses
            End If
    ...
    Private Sub txtLHPayments_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtLHPayments.KeyUp
        Try
            If Not txtLHPayments.Text.Contains(".") And Double.Parse(txtLHPayments.Text) > 0 Then
                txtLHPayments.Text = Format(Val(Replace(txtLHPayments.Text, ",", "")), "##,###,###")
                txtLHPayments.Select(txtLHPayments.Text.Length, 0)

                'update loan balance...
                txtTotalLoanBal.Text = Format(Val(Replace(Double.Parse(txtLHPayments.Text) + Double.Parse(txtprin.Text), ",", "")), "##,###,###")
    ...
    Private Sub txtRenewAmt_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtRenewAmt.KeyUp
        Try
            If Not txtRenewAmt.Text.Contains(".") And Double.Parse(txtRenewAmt.Text) > 0 Then
                txtRenewAmt.Text = Format(Val(Replace(txtRenewAmt.Text, ",", "")), "##,###,###")
                txtRenewAmt.Select(txtRenewAmt.Text.Length, 0)

                'update net loan balance...
                txtNetLoanAmt.Text = Format(Val(Replace(Double.Parse(txtRenewAmt.Text) - Double.Parse(txtTotalLoanBal.Text), ",", "")), "##,###,###")
    ...
    Private Sub txtRenewAmt_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtRenewAmt.KeyPress
        Try
            Dim dot As Integer, ch As String
            If Not Char.IsDigit(e.KeyChar) Then e.Handled = True
            If e.KeyChar = "." And txtRenewAmt.Text.IndexOf(".") = -1 Then e.Handled = False 'allow single decimal point

            dot = txtRenewAmt.Text.IndexOf(".")
            If dot > -1 Then            'allow only 2 decimal places
                ch = txtRenewAmt.Text.Substring(dot + 1)
                If ch.Length > 1 Then e.Handled = True 'does not allow any other keypresses
            End If
    ...
    Private Sub txtRenewAmt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtRenewAmt.TextChanged

    End Sub

    Private Sub txtpayment_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtpayment.TextChanged, txtLHPayments.TextChanged

    End Sub

    Private Sub txtTotalLoanBal_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtTotalLoanBal.TextChanged
    ...
    Private Sub frm_renew_amount_LocationChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LocationChanged
    ...
    Private Sub txtcycle_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtcycle.TextChanged
