...
Public Class General_masterlist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gsoft.General_masterlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGeneral_masterlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As General_masterlist = New General_masterlist()
        rpt.Site = Me.Site
        Return rpt
    End Function
